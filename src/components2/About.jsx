    ...
    >
      <div className="w-full flex justify-center items-center overflow-hidden">
        <div className="flex flex-col p-4">
          <h2
            className={`font-poppins font-semibold sm:text-[50px] text-[38px] sm:leading-[70px] leading-[50px] text-white opacity-90 ${
          ...
          <div
            className={`border-[#962929] border-b-[5px] rounded-2xl ${
      ...
      <div className="flex items-center sm:items-start justify-center sm:flex-row flex-col w-full sm:max-w-[924px] overflow-hidden">
        <h4
          className={`font-poppins font-semibold text-[32px] leading-[48px] sm:w-[50%] text-white opacity-[80%] sm:text-right text-left sm:px-3 px-0 py-2 ${
        ...
        <p
          className={`${
            styles.paragraph
          } sm:w-[50%] text-white opacity-[60%] sm:px-7 sm:py-5 px-0 py-1 ${
